        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden sm:block sm:ml-6">
            <div className="flex space-x-4">
              <Link to="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 no-underline	 py-2 rounded-md text-sm font-medium">
                Home
              </Link>
              <Link to="/about" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 no-underline	 py-2 rounded-md text-sm font-medium">
                About
              </Link>
              <Link to="/contact" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 no-underline	 py-2 rounded-md text-sm font-medium">
                Contact
              </Link>
            </div>
          </div>
